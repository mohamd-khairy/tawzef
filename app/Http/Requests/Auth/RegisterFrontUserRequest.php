...
class RegisterFrontUserRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'full_name' => 'nullable|max:191|regex:/^[ a-zA-Z]+$/u',
            ...
            'mobile_number' => array('required', 'min:11', 'max:11', 'regex:/((?:\+|00)[17](?: |\-)?|(?:\+|00)[1-9]\d{0,2}(?: |\-)?|(?:\+|00)1\-\d{3}(?: |\-)?)?(0\d|\([0-9]{3}\)|[1-9]{0,3})(?:((?: |\-)[0-9]{2}){4}|((?:[0-9]{2}){4})|((?: |\-)[0-9]{3}(?: |\-)[0-9]{4})|([0-9]{7}))/'),
