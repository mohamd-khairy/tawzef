@section('title', trans('cms::cms.term'))
        ...
        <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title">
                            <span data-loadtitle>{{trans('cms::cms.terms')}}</span>
                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            {{--
                            <!-- Full creation form -->
                            <a href="{{route('terms.create')}}" data-load class="btn btn-brand btn-icon-sm">
                                <i class="flaticon2-plus"></i> {{trans('cms::cms.create_new')}}
                            </a>
                            --}}
                            @if (auth()->user()->hasPermission('create-terms-condition'))
                                <a href="{{route('terms.create')}}" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#vcxl_modal" data-path="{{route('terms.modals.create')}}" data-title="{{trans('cms::cms.create_term')}}" data-modal-load>
                                    <span>
                                        <i class="la la-plus"></i>
                                        <span>{{trans('cms::cms.create_term')}}</span>
                                    </span>
                                </a>
                            @endif
                            {{--
                ...
                <div class="kt-portlet__body">
                    ...
                    <!--begin: Datatable -->
                    <table class="table table-striped- table-bordered table-hover table-checkable datatable" id="terms_table">
                        <thead>
                            <tr>
                                <th>{{__('cms::cms.id')}}</th>
                                <th>{{__('cms::cms.term')}}</th>
