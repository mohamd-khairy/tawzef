...
@section('content')
    ...
    <!--begin::Form-->
    <form action="{{ route('awards.store') }}" method="POST" id="create_awards_form" enctype="multipart/form-data"
        ...
        <div class="m-portlet__body">
            <div class="row col-12">
                <div class="col-6">
                    <label>{{trans('cms::cms.award_date')}} <small class="text-muted"></small></label>
                    <input name="award_date" autocomplete="off" id="m_datepicker" class="form-control datepicker-init" placeholder="{{trans('cms::cms.award_date')}}" data-parsley-trigger="change focusout" />
                </div>
                <div class="col-6">
                    <label for="award_section">{{ __('cms::cms.award_section') }}</label>
                    <select class="form-control" id="award_section" name="award_section" 
                        data-parsley-trigger="change focusout" onclick="loadImageDim($(this).val())">
                        <option value="" selected disabled>{{ __('cms::cms.award_section') }}</option>
                        <option value="top_awards">{{ __('cms::cms.top_awards') }}</option>
                        <option value="top_awards_list">{{ __('cms::cms.top_awards_list') }}</option>
                        <option value="best_designs">{{ __('cms::cms.best_designs') }}</option>
                    </select>
                </div>
            </div>
                            ...
                            <div data-repeater-item class="row">
                                ...
                                <div class="col-6 mt-5">
                                    ...
                                    <input name="title" id="title" type="text" class="form-control"
                                        ...
                                        data-parsley-maxlength-message="{{ __('cms::cms.awards_max_is_150_characters_long') }}">
                                </div>
                                ...
                                <div class="col-12 mt-5">
                                    ...
                                    <textarea name="description" id="description-0" class="form-control description"
                                        placeholder="{{ __('cms::cms.please_enter_the_awards') }}" required
                                        data-parsley-required
                ...
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            {{-- <a href="{{route('awards.create')}}" data-load class="btn btn-brand btn-icon-sm">
