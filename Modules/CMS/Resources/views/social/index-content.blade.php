@section('title', trans('cms::cms.social'))
                ...
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title">
                            <span data-loadtitle>{{trans('cms::cms.socials')}}</span>
                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            ...
                            --}}
                            @if (auth()->user()->hasPermission('create-social-content'))
                                <a href="{{route('socials_content.create')}}" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#vcxl_modal" data-path="{{route('socials_content.modals.create')}}" data-title="{{trans('cms::cms.create_social')}}" data-modal-load>
                                    <span>
                                        <i class="la la-plus"></i>
                                        <span>{{trans('cms::cms.create_social')}}</span>
                                    </span>
                                </a>
                            @endif
                            {{--
