...
@section('content')
    ...
    <!--begin::Form-->
    <form action="{{ route('technologies.update') }}" method="POST" id="update_technology_form"
            ...
            <div class="form-group row col-12">
                <div class="repeater col-12">
                    <div data-repeater-list="translations">
                        @foreach ($technology->translations as $index => $translation)
                            <div data-repeater-item class="row">
                                ...
                                <div class="col-6 mt-5">
                                    ...
                                    <input name="title" id="title" type="text" value="{{ $translation->title }}"
                                        ...
                                        data-parsley-maxlength-message="{{ __('cms::cms.technology_max_is_150_characters_long') }}">
                                </div>
                                ...
                                <div class="col-12 mt-5">
                                    ...
                                    <textarea name="description" id="description-{{ $index }}" class="form-control description"
                                        placeholder="{{ __('cms::cms.please_enter_the_technology') }}" required
                                        data-parsley-required
                        ...
                        @endforeach
                        @if (!$technology->translations->count())
                            <div data-repeater-item class="row">
            ...
            <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-6">
                            <button type="submit"
                                class="btn btn-success btn-brand">{{ trans('cms::cms.update_technology') }}</button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    function updateAboutCallback() {
        ...
        // Reload datatable
        technologies_table.ajax.reload(null, false);
    }
