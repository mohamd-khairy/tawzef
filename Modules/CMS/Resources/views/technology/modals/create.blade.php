...
@section('content')
    ...
    <!--begin::Form-->
    <form action="{{ route('technologies.store') }}" method="POST" id="create_technologies_form" enctype="multipart/form-data"
                            ...
                            <div data-repeater-item class="row">
                                ...
                                <div class="col-6 mt-5">
                                    ...
                                    <input name="title" id="title" type="text" class="form-control"
                                        ...
                                        data-parsley-maxlength-message="{{ __('cms::cms.technologies_max_is_150_characters_long') }}">
                                </div>
                                ...
                                <div class="col-12 mt-5">
                                    ...
                                    <textarea name="description" id="description-0" class="form-control description"
                                        placeholder="{{ __('cms::cms.please_enter_the_technologies') }}" required
                                        data-parsley-required
