...
@section('content')
    ...
    <!--begin::Form-->
    <form action="{{ route('magazines.store') }}" method="POST" id="create_magazines_form" enctype="multipart/form-data"
        ...
        <div class="m-portlet__body">
            <div class="form-group row">
                            ...
                            <div data-repeater-item class="row">
                                ...
                                <div class="col-6 mt-5">
                                    ...
                                    <input name="title" id="title" type="text" class="form-control"
                                        ...
                                        data-parsley-maxlength-message="{{ __('cms::cms.magazines_max_is_150_characters_long') }}">
                                </div>
                                ...
                                <div class="col-12 mt-5">
                                    ...
                                    <textarea name="description" id="description-0" class="form-control description"
                                        placeholder="{{ __('cms::cms.please_enter_the_magazines') }}" required
                                        data-parsley-required
                ...
                <div class="form-group row">
                    <div class="col-6">
                        <label for="attachments">{{__('cms::cms.attachments')}}</label>
                        <input type="file" name="image" class="form-control" id="attachments" data-multiple-caption="{count} {{trans('cms::cms.files_selected')}}" />
                        <strong>Image dimensions :  270 x 25 </strong>
                    </div>
                    <div class="col-6">
                        <label for="magazine_logo">{{__('cms::cms.magazine_logo')}}</label>
                        <input type="file" name="magazine_logo" class="form-control" id="magazine_logo" data-multiple-caption="{count} {{trans('cms::cms.files_selected')}}" />
                ...
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            {{-- <a href="{{route('magazines.create')}}" data-load class="btn btn-brand btn-icon-sm">
