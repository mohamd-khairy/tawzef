...
@section('content')
    ...
    <!--begin::Form-->
    <form action="{{ route('magazines.update') }}" method="POST" id="update_magazine_form"
            ...
            <div class="form-group row col-12">
                <div class="repeater col-12">
                    <div data-repeater-list="translations">
                        @foreach ($magazine->translations as $index => $translation)
                            <div data-repeater-item class="row">
                                ...
                                <div class="col-6 mt-5">
                                    ...
                                    <input name="title" id="title" type="text" value="{{ $translation->title }}"
                                        ...
                                        data-parsley-maxlength-message="{{ __('cms::cms.magazine_max_is_150_characters_long') }}">
                                </div>
                                ...
                                <div class="col-12 mt-5">
                                    ...
                                    <textarea name="description" id="description-{{ $index }}" class="form-control description"
                                        placeholder="{{ __('cms::cms.please_enter_the_magazine') }}" required
                                        data-parsley-required
                        ...
                        @endforeach
                        @if (!$magazine->translations->count())
                            <div data-repeater-item class="row">
                ...
                <div class="form-group row">
                    <div class="col-lg-3">
                        <label for="attachments">{{__('informations::information.attachments')}} </label>
                        ...
                        <strong>Image dimensions :  270 x 25 </strong>
                        <img src="{{ asset('storage/'.$magazine->image) }}" class="w-100" alt="">
                    </div>
                    <div class="col-lg-3">
                        <label for="magazine_logo">{{__('informations::information.magazine_logo')}} </label>
                        <input type="file" name="magazine_logo" class="form-control" id="magazine_logo" data-multiple-caption="{count} {{trans('informations::information.files_selected')}}" />
                        <strong>Image dimensions :  100 x 125 </strong>
                        <img src="{{ asset('storage/'.$magazine->magazine_logo) }}" class="w-100" alt="">
                    </div>
                </div>
            ...
            <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-6">
                            <button type="submit"
                                class="btn btn-success btn-brand">{{ trans('cms::cms.update_magazine') }}</button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    function updateAboutCallback() {
        ...
        // Reload datatable
        magazines_table.ajax.reload(null, false);
    }
