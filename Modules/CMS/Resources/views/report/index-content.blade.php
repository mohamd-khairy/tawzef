@section('title', trans('cms::cms.report'))
        ...
        <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title">
                            <span data-loadtitle>{{trans('cms::cms.reports')}}</span>
                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            {{--
                            <!-- Full creation form -->
                            <a href="{{route('reports.create')}}" data-load class="btn btn-brand btn-icon-sm">
                                <i class="flaticon2-plus"></i> {{trans('cms::cms.create_new')}}
                            </a>
                            --}}
                            @if (auth()->user()->hasPermission('create-report'))
                                <a href="{{route('reports.create')}}" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#vcxl_modal" data-path="{{route('reports.modals.create')}}" data-title="{{trans('cms::cms.create_report')}}" data-modal-load>
                                    <span>
                                        <i class="la la-plus"></i>
                                        <span>{{trans('cms::cms.create_report')}}</span>
                                    </span>
                                </a>
                            @endif
                            {{--
                ...
                <div class="kt-portlet__body">
                    ...
                    <!--begin: Datatable -->
                    <table class="table table-striped- table-bordered table-hover table-checkable datatable" id="reports_table">
                        <thead>
                            <tr>
                                <th>{{__('cms::cms.id')}}</th>
                                <th>{{__('cms::cms.report')}}</th>
