...
@section('content')
    ...
    <!--begin::Form-->
    <form action="{{ route('reports.store') }}" method="POST" id="create_reports_form" enctype="multipart/form-data"
                            ...
                            <div data-repeater-item class="row">
                                ...
                                <div class="col-6 mt-5">
                                    ...
                                    <input name="title" id="title" type="text" class="form-control"
                                        ...
                                        data-parsley-maxlength-message="{{ __('cms::cms.reports_max_is_150_characters_long') }}">
                                </div>
