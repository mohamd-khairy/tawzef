...
<script>
    function initTable1(url) {
        ...
        return table.DataTable({
            ...
            columns: [
                ...
                // {data: 'best_time_to_call_from', orderable: false, searchable: false},
                // {data: 'best_time_to_call_to', orderable: false, searchable: false},
            ...
            columnDefs: [
                ...
                {
                    targets: 2,
                    title: '{{trans('contactus::contact_us.phone_number')}}',
                    render: function(data, type, full, meta) {
    ...
    jQuery(document).ready(function() {
        // Init datatable
        contact_us = initTable1('{{ route('contact_us.contact_us.indexAdRequests') }}');
        ...
        $('#m_search').on('click', function(e) {
            ...
            contact_us = initTable1('{{ route('contact_us.contact_us.indexAdRequests') }}'+'?'+query);
        });
