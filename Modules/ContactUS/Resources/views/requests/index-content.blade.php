        ...
        <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title">
                            <span data-loadtitle>{{trans('contactus::contact_us.request')}}</span>
                ...
                <div class="kt-portlet__body">
                    ...
                    <!--begin: Datatable -->
                    <table class="table table-striped- table-bordered table-hover table-checkable datatable" id="contact_us_table">
                        <thead>
                            <tr>
                                <th>{{__('contactus::contact_us.id')}}</th>
                                <th>{{__('contactus::contact_us.request')}}</th>
                                <th>{{__('contactus::contact_us.subject')}}</th>
                                <th>{{__('contactus::contact_us.email')}}</th>
                                <th>{{__('contactus::contact_us.message')}}</th>
                                <th>{{__('contactus::contact_us.link')}}</th>
                                <!-- <th>{{__('contactus::contact_us.best_from')}}</th>-->
                                <th>{{__('contactus::contact_us.created_at')}}</th>
                                <th>{{__('contactus::contact_us.readed')}}</th> 
