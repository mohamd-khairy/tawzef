...
namespace Modules\Socials\Http\Middleware;
...
class HasSocialsModule
{
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        $hosts = Cache::rememberForever('has_socials_module', function () {
            $socials_module = DB::connection('mysql')->table('modules')->where('name', 'Socials Module')->first();
