            ...
            columnDefs: [{
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        value += `
                                    <a href="{{route('settings.how_works.modals.update')}}" class="dropdown-item" data-toggle="modal" data-target="#vcxl_modal" data-path="{{route('settings.how_works.modals.update')}}" data-title="{{trans('settings::settings.update_how_work')}}" data-id="` + full.id + `" data-modal-load>
                                        <span>
                        ...
                        value += `
                                    <a class="dropdown-item" data-delete-it='{"container":false, "path":"` + delete_url + `", "callback": "deleteHowWorkCallback"}' href="#"><i class="la la-trash"></i> {{__('settings::settings.delete_how_work')}}</a>
                                `;
                        @endif
