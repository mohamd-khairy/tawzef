                ...
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title">
                            <span data-loadtitle>{{trans('settings::settings.footerlinks')}}</span>
                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            ...
                            @if (auth()->user()->hasPermission('create-settings-footer-link'))
                                <a href="{{route('settings.footer_links.create')}}" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#vcxl_modal" data-path="{{route('settings.footer_links.modals.create')}}" data-title="{{trans('settings::settings.create_footer_link')}}" data-modal-load>
                                    <span>
