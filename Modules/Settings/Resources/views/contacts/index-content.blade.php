        ...
        <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
            <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title">
                            <span data-loadtitle>{{trans('settings::settings.contacts')}}</span>
                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            ...
                            --}}
                            @if (auth()->user()->hasPermission('create-settings-contact'))
                            <a href="{{route('settings.contacts.create')}}" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#vcxl_modal" data-path="{{route('settings.contacts.modals.create')}}" data-title="{{trans('settings::settings.create_contacts')}}" data-modal-load>
                                <span>
                                    <i class="la la-plus"></i>
                                    <span>{{trans('settings::settings.create_contact')}}</span>
                                </span>
                            </a>
                            @endif
                            {{--
                ...
                <div class="kt-portlet__body">
                    <!--begin: Datatable -->
                    <table class="table table-striped- table-bordered table-hover table-checkable datatable" id="contacts_table">
                        <thead>
                            <tr>
                                <th>{{__('settings::settings.id')}}</th>
                                <th>{{__('settings::settings.type')}}</th>
                                <th>{{__('settings::settings.contact')}}</th>
