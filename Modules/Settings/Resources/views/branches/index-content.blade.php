        ...
        <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title">
                            <span data-loadtitle>{{trans('settings::settings.branches')}}</span>
                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            ...
                            --}}
                            @if (auth()->user()->hasPermission('create-settings-branch'))
                                <a href="{{route('settings.branches.create')}}" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#vcxl_modal" data-path="{{route('settings.branches.modals.create')}}" data-title="{{trans('settings::settings.create_branch')}}" data-modal-load>
                                    <span>
                                        <i class="la la-plus"></i>
                                        <span>{{trans('settings::settings.create_branch')}}</span>
                                    </span>
                                </a>
                            @endif
                            {{--
                ...
                <div class="kt-portlet__body">
                    <!--begin: Datatable -->
                    <table class="table table-striped- table-bordered table-hover table-checkable datatable" id="branches_table">
                        <thead>
                            <tr>
                                <th>{{__('settings::settings.id')}}</th>
                                <th>{{__('settings::settings.branch')}}</th>
