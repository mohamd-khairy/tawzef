                ...
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title">
                            <span data-loadtitle>{{trans('users.users')}}</span>
                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            @haspermission('create-user')
                                <a href="{{route('users.create')}}" class="btn btn-brand btn-sm" data-toggle="modal" data-target="#vcxl_modal" data-path="{{route('users.modals.create')}}" data-title="{{trans('users.create_user_form')}}" data-modal-load>
                                    <span>
