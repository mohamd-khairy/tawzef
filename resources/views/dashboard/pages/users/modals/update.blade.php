...
@section('content')
    <!--begin::Form-->
    <form action="{{route('users.update')}}" method="POST" id="update_user_form" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator" data-async data-callback="updateUserCallback" data-parsley-validate>
        @csrf
        ...
        <div class="m-portlet__body">
            ...
            <div class="form-group m-form__group row">
                ...
                <div class="col-lg-8">
                    <input name="mobile_number" id="mobile_number" type="text" class="form-control m-input" placeholder="{{trans('users.enter_mobile_number')}}" required data-parsley-required data-parsley-required-message="{{trans('users.mobile_number_is_required')}}" data-parsley-trigger="change focusout" data-parsley-maxlength="150" data-parsley-maxlength-message="{{trans('users.mobile_number_max_is_150_characters_long')}}" data-parsley-pattern="/((?:\+|00)[17](?: |\-)?|(?:\+|00)[1-9]\d{0,2}(?: |\-)?|(?:\+|00)1\-\d{3}(?: |\-)?)?(0\d|\([0-9]{3}\)|[1-9]{0,3})(?:((?: |\-)[0-9]{2}){4}|((?:[0-9]{2}){4})|((?: |\-)[0-9]{3}(?: |\-)[0-9]{4})|([0-9]{7}))/" data-parsley-pattern="{{trans('users.mobile_number_is_invalid')}}" value="{{$user->mobile_number}}">
            ...
            <div class="form-group m-form__group row">
                ...
                <div class="col-lg-8">
                    <input name="full_name" id="full_name" type="text" class="form-control m-input" placeholder="{{trans('users.enter_full_name')}}" data-parsley-trigger="change focusout" data-parsley-maxlength="150" data-parsley-maxlength-message="{{trans('users.full_name_max_is_150_characters_long')}}" value="{{$user->full_name}}">
            ...
            <div class="form-group m-form__group row">
                ...
                <div class="col-lg-8">
                    <textarea name="bio" id="bio" type="text" class="form-control m-input" placeholder="{{trans('users.enter_bio')}}" data-parsley-trigger="change focusout" data-parsley-maxlength="4294967295" data-parsley-maxlength-message="{{trans('users.bio_max_is_4294967295_characters_long')}}">{{$user->bio}}</textarea>
        ...
        <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
            <div class="m-form__actions m-form__actions--solid">
                <div class="row">
                    <div class="col-lg-6">
                        <button type="submit" class="btn btn-success">{{trans('users.update_user')}}</button>
                    </div>
                </div>
            </div>
        </div>
